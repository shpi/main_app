...
class UIShutter(QObject):
    ...
    def set_actual_position_path(self, key):
    ...
    def set_desired_position_path(self, key):
    ...
    def thread(self):
        while(self._actual_position != None and self._actual_position != self._desired_position):
            time.sleep(0.1)
