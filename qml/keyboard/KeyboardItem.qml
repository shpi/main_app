    ...
    Column {
        ...
        Repeater {
            ...
            Row {
                ...
                anchors.horizontalCenter: if (parent)
                ...
                Repeater {
                    ...
                    Key {
                        ...
                        isChecked: isChekable && command && command === "shift"
                                   && allUpperCase
                        property int repcount: keyRepeater.count
