...
static void createModuleConstants(void) {
    loadConstantsBlob(&mod_consts[0], "PySide2", 79);
...
void checkModuleConstants_PySide2(void) {
    ...
    checkConstantsBlob(&mod_consts[0], "PySide2", 79);
}
#endif
...
static PyObject *impl_PySide2$$$function__2__setupQtDirectories(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    branch_yes_3:;
    {
...

        {
            ...
            tmp_tuple_element_2 = impl___main__$$$function__9_complex_call_helper_keywords_star_dict(dir_call_args);
        }
...
// Mark the execution in the "__spec__" value.
    ...
    }
    {
        ...
        UPDATE_STRING_DICT1(moduledict_PySide2, (Nuitka_StringObject *)mod_consts[65], tmp_assign_source_5);
    }
    {
        PyObject *tmp_assign_source_6;
