...
static void createModuleConstants(void) {
    loadConstantsBlob(&mod_consts[0], "core", 7);
...
void checkModuleConstants_core(void) {
    ...
    checkConstantsBlob(&mod_consts[0], "core", 7);
}
#endif
...
function_impl_code functable_core[] = {
...
static PyObject *_reduce_compiled_function(PyObject *self, PyObject *args, PyObject *kwds) {
    ...
    function_impl_code *current = functable_core;
    int offset = 0;
...
static PyObject *_create_compiled_function(PyObject *self, PyObject *args, PyObject *kwds) {
    ...
    if (offset > sizeof(functable_core) || offset < 0) {
...
NUITKA_MAY_BE_UNUSED static char const *module_full_name = "core";

// Internal entry point for module code.
PyObject *modulecode_core(PyObject *module, struct Nuitka_MetaPathBasedLoaderEntry const *module_entry) {
    module_core = module;
    ...
    if (_init_done) {
#ifdef _NUITKA_TRACE
        PRINT_STRING("core: Skipping module init, already done.\n");
#endif
...
#ifdef _NUITKA_TRACE
    PRINT_STRING("core: Calling createModuleConstants().\n");
#endif
    createModuleConstants();

    /* The code objects used by this module are created now. */
#ifdef _NUITKA_TRACE
    PRINT_STRING("core: Calling createModuleCodeObjects().\n");
#endif
...
// Set the "__spec__" value
    ...
    // Other modules get a "ModuleSpec" from the standard mechanism.
    {
        ...
        PyObject *spec_value = CALL_FUNCTION_WITH_SINGLE_ARG(_spec_from_module, module_core);
...
// Mark the execution in the "__spec__" value.
    ...
    // Module code.
    {
        ...
        UPDATE_STRING_DICT1(moduledict_core, (Nuitka_StringObject *)mod_consts[5], tmp_assign_source_1);
    }
